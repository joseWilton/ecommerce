...
class User extends Model{
    ...
    public static function verifyLogin($inadmin = true){
		...
		if(
			...
			|| // ou
			!$_SESSION[User::SESSION] // se for diferente
			||
			!(int)$_SESSION[User::SESSION]["iduser"]>0 // se for maior que 0 então é um usuario
			||
			(bool)$_SESSION[User::SESSION]["inadmin"] !== $inadmin
		){
			header("Location: /admin/login"); //redireciona para pagina de login
			exit;
		}
